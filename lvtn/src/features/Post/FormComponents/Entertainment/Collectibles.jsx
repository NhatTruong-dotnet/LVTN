...
function Collectibles({ formData, handleFormDataChange }) {
    return (
        <>
            ...
            <FormGroup title='Thông tin chi tiết'>
                <div className={styles.group}>
                    <FormInput
                        require
                        label='Loại sản phẩm'
                        value={formData.doSuuTamLoaiSanPham}
                        onChange={e =>
                        ...
                        requireData={[
                            { value: 'Thạch anh, đá quý' },
                            { value: 'Tranh ảnh, khung ảnh' },
                            { value: 'Bật lửa, tượng trang trí' },
                            { value: 'Đồ gốm sứ' },
                            { value: 'Các loại khác' },
                        ]}
                    />
